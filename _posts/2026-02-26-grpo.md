...
In this blog post, I provide a review of \*PO (i.e. Policy Optimization or Preference Optimization) algorithms, especially including *Group Relative Policy Optimization (GRPO)*<d-cite key="shao2024deepseekmath"></d-cite>, its ancestors and its descendants, mainly for my own reference.
...
| ------ | ------------------------- | -------------- |
| PPO    | Token                     | Online         |
| GRPO   | Token, but often sequence | Online         |
| DAPO   | Token                     | Online         |

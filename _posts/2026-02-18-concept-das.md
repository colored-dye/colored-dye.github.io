...
I tested CDAS on the *Mechanistic Interpretability Benchmark (MIB)*<d-cite key="mueller2025mib"></d-cite>, and 
...
<div class="caption" id="results_mcqa">
    Figure 1. IIA results on MCQA task with CDAS and Gemma2-2B.
</div>

Results are shown in <a href="#results_mcqa">Figure 1</a>.
